            ...
            >
              ...
              >
                <span className="relative z-10 flex items-center gap-4 transition-all duration-700 ease-[0.16,1,0.3,1] group-hover:tracking-[0.3em]">
                  EXPLORE JOURNAL <ArrowRight className="w-3.5 h-3.5 group-hover:translate-x-3 group-hover:text-white group-hover:fill-white transition-all duration-700 ease-[0.16,1,0.3,1]" />
                </span>
