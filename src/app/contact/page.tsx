...
export default function ContactPage() {
  ...
  return (
    <div className="bg-[#050505] min-h-screen relative overflow-hidden selection:bg-brand-red selection:text-white">
      ...
      <div className="max-w-[1600px] mx-auto px-6 lg:px-20 py-24 relative z-10">
        ...
        {/* Editorial Hero (Center Aligned, min-h-[30vh]) */}
        <div className="min-h-[30vh] flex flex-col items-center justify-center text-center mb-16 border-b border-white/10 pb-16">
          ...
          >
            ...
            <p className="font-sans text-[11px] md:text-xs text-white/50 leading-[1.8] uppercase tracking-wider pt-4">
              Private communication channels for:<br />
              <span className="text-white/80 mt-1 block">Editorial // Wholesale // Creative Projects</span>
            </p>
          </motion.div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.2fr_0.8fr] gap-12 lg:gap-16">
          ...
          <motion.div
            ...
            className="bg-black/20 border border-white/5 p-8 md:p-12"
          >
              ...
              <form onSubmit={handleSubmit} className="space-y-12">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                  ...
                  <div className="relative">
                    <label className="font-caption text-[9px] tracking-widest text-white/40 uppercase block mb-4">Identity / Alias</label>
                    <input
                      type="text"
                      required
                      value={form.name}
                      ...
                      className="w-full bg-transparent border-0 border-b border-white/20 pb-4 text-xs tracking-wider text-white uppercase placeholder-white/10 focus:outline-none focus:border-brand-red focus:ring-0 font-sans transition-colors duration-300"
                    />
                  </div>

                  {/* Email */}
                  <div className="relative">
                    <label className="font-caption text-[9px] tracking-widest text-white/40 uppercase block mb-4">Channel / Email</label>
                    <input
                      type="email"
                      required
                      value={form.email}
                ...
                {/* Department */}
                <div className="relative">
                  <label className="font-caption text-[9px] tracking-widest text-white/40 uppercase block mb-4">Inquiry Type</label>
                  <div className="relative">
                    <select
                      value={form.department}
                      onChange={(e) => setForm({ ...form, department: e.target.value })}
                      className="w-full bg-transparent border-0 border-b border-white/20 pb-4 text-xs tracking-widest text-white uppercase focus:outline-none focus:border-brand-red focus:ring-0 font-sans cursor-pointer appearance-none transition-colors duration-300"
                    >
                      ...
                      <option value="design" className="bg-[#0c0c0c]">Creative Projects</option>
                    </select>
                    <div className="absolute right-0 top-1/2 -translate-y-1/2 pointer-events-none pb-4 text-white/40 text-xs">▼</div>
                  </div>
                </div>

                {/* Message */}
                <div className="relative">
                  <label className="font-caption text-[9px] tracking-widest text-white/40 uppercase block mb-4">Dispatch Details</label>
                  <textarea
                    rows={6}
                    required
                    value={form.message}
                    ...
                    className="w-full bg-transparent border-0 border-b border-white/20 pb-4 text-xs tracking-wider text-white placeholder-white/10 focus:outline-none focus:border-brand-red focus:ring-0 font-sans resize-none transition-colors duration-300"
                  />
                </div>
                ...
                <div className="pt-6">
                  <button
                    type="submit"
                    className="group flex items-center justify-center space-x-4 w-full bg-[#F5F5F5] hover:bg-brand-red text-[#050505] hover:text-white font-heading text-xs tracking-[0.2em] uppercase py-5 transition-all duration-500 font-bold"
                  >
          ...
          <motion.div
            ...
            className="bg-black/20 border border-white/5 p-8 md:p-10 flex flex-col space-y-12 relative"
          >
            {/* Studio Info Block */}
            ...
            <motion.div
              ...
              className="relative bg-[#e0e0e0] p-6 shadow-xl cursor-pointer mt-auto border border-black/10 mx-4"
            >
              {/* Tape detail */}
        ...
        <div className="flex justify-between items-center mt-16 font-mono text-[9px] text-white/20 tracking-widest uppercase border-t border-white/5 pt-6">
