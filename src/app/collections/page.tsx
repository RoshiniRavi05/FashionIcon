  ...
  return (
    <div className="bg-[#050505] min-h-screen py-20 px-6 md:px-12 max-w-[1600px] mx-auto space-y-20">
      ...
      <div className="space-y-4 pt-10">
        ...
        <h1 className="font-hero text-3xl sm:text-5xl md:text-6xl tracking-wide uppercase text-white leading-tight">
          CAPSULE RELEASES
        </h1>
          ...
          >
            ...
            <div className="relative z-10 space-y-6">
              ...
              <Link
                ...
                className="font-heading text-[10px] tracking-[0.2em] uppercase bg-[#F5F5F5] text-[#050505] hover:bg-brand-red hover:text-white px-8 py-3.5 transition-all duration-300 font-bold inline-flex items-center space-x-2"
              >
